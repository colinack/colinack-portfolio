        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              className="comic-border-thick comic-shadow bg-accent text-accent-foreground p-6 md:p-8 relative md:col-span-7 rotate-[-1deg] hover:rotate-0 hover:-translate-y-1 transition-all duration-300"
            >
            ...
            <motion.div
              ...
              className="comic-border-thick comic-shadow bg-card p-6 md:p-8 halftone relative md:col-span-5 rotate-[2deg] hover:rotate-0 hover:-translate-y-1 transition-all duration-300 z-10"
            >
            ...
            <motion.div
              ...
              className="comic-border-thick comic-shadow bg-comic-purple text-primary-foreground p-6 md:p-10 halftone relative md:col-span-12 lg:col-span-10 lg:col-start-2 rotate-[-1deg] hover:rotate-[1deg] hover:-translate-y-1 transition-all duration-300"
            >
              <div className="relative z-10">
