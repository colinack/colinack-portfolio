...
const ComicNav = () => {
  ...
  return (
    <motion.nav
      ...
      scrolled ?
      "bg-card/95 backdrop-blur-sm comic-border-thick border-t-0 border-l-0 border-r-0" :
      "bg-transparent"}`
      }>
      ...
      <div className="container mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <a
            key={item.href}
            href={item.href}
            className="font-display text-lg px-4 py-2 text-foreground hover:bg-accent hover:text-accent-foreground comic-border transition-all hover:comic-shadow-sm">
