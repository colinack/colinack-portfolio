                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        ...
                        <div className="mt-4 flex w-full">
                            <a
                                href="#"
                                className="w-full flex items-center justify-center gap-2 bg-foreground text-background comic-border-thick comic-shadow px-4 py-3 font-display text-xl comic-hover hover:bg-card hover:text-card-foreground transition-colors"
                                target="_blank"
